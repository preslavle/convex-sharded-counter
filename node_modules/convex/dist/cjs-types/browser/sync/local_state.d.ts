...
export declare class LocalSyncState {
    ...
    subscribe(udfPath: string, args: Record<string, Value>, journal?: QueryJournal, componentPath?: string): {
    ...
    resume(remoteQueryResults: Set<QueryId>): [QuerySetModification?, Authenticate?];
